...
The original map modified to include travel arrows from Startburg south 21 units, east 76 units and north 42 units, ending up in Endville via Westown and Eastham.

## Approach 1: Describe Transitions
![Route](/assets/rest-what/slide2.png){: style="float: right; width: 50%; margin-left: 1em;"}
...
The original map modified with everything shaded except Endville, with a red arrow pointing to it and saying "Come to Endville, wherever you are!"

## Approach 2: Specify the desired state
![Destination](/assets/rest-what/slide3.png){: style="float: left; width: 50%; margin-right: 1em;"}
